...
if __name__ == '__main__':
    ...
    #        print(pretty_format(model_output))
    #    print("\nTime infer: {}s".format(time.time() - start_time))

    #infer by file
    # with open("evaluate/eval_indomain.src", "r") as f:
    #     sentences = f.readlines()
    # start_time = time.time()
    # with open("evaluate/eval_indomain_2.hyp", "w") as f:
    ...
    for i, sentence in enumerate(sentences):
        ...
        if isinstance(overlap, str):
            ...
            overlap_list.append(remove_punc_selection(sentence, output_sent))
        else:
            sub_list = []
            for sent in overlap:
            ...
            overlap_list.append(remove_punc_selection(sentence, full_sentence))
