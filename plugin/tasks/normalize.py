...
from utils import tokenize_line_char, tokenize_line_word, load_pretrain_lm

from fairseq.tasks import FairseqTask, register_task

from plugin.data.normalize_dataset import NormalizeDataset
...
@register_task('normalize')
class Normalize(FairseqTask):
    ...
    def add_args(parser):
        ...
        parser.add_argument('--trained-lm', default=None, type=str,
                            help='pre-trained language model')
        parser.add_argument('--fine-tuning-lm', default='False', type=str, metavar='BOOL',
                            help='fine tuning pre-trained language model')
        parser.add_argument('--rnn-type', default=None, type=str,
                            help='LSTM or GRU or None')
        parser.add_argument('--rnn-layers', default=2, type=int, metavar='N',
    ...
    def __init__(self, args, src_dict, tgt_dict, trained_lm):
        super().__init__(args)
        self.src_dict = src_dict
        self.tgt_dict = tgt_dict
        self.trained_lm = trained_lm
    ...
    def setup_task(cls, args, **kwargs):
        ...
        if args.trained_lm:
            trained_lm = load_pretrain_lm(args.trained_lm)
            src_dict = trained_lm.task.source_dictionary
            if args.fine_tuning_lm == 'False':
                for param in trained_lm.model.parameters():
        ...
        return cls(args, src_dict, tgt_dict, trained_lm)
